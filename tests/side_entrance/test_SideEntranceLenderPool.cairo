%lang starknet
from src.side_entrance.SideEntranceLenderPool import (
    depositTokens,
    withdrawTokens,
    flashLoan,
    userBalance,
...
@external
func test_depositTokens{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    alloc_locals;
